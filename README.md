## The OpenStreetMap Package [![Build Status](https://ci.joomla.org/api/badges/joomla-framework/openstreetmap-api/status.svg)](https://ci.joomla.org/joomla-framework/openstreetmap-api)
